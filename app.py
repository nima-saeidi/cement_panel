...
import base64
# from flask_wtf.csrf import CSRFProtect  # Removed import
...
app = Flask(__name__)
# csrf = CSRFProtect(app)  # Commented out CSRF initialization
...
# app.config['WTF_CSRF_ENABLED'] = True  # Commented out CSRF enabling
...
def gemini_api():
    ...
    static_prompt = """
    تصور کن که تو یک مهندس عمران با ۲۰ سال تجربه در زمینه بتن هستی. مشکل بتن تو این عکس چیه؟ چی باعث این مشکل شده؟ به فارسی و با زبانی ساده و حرفه‌ای توضیح بده. پاسخ رو کوتاه و مفید نگه دار، حداکثر ۳-۴ جمله، و فقط مشکل، دلیل، و یک راهکار عملی ذکر کن.
    """
